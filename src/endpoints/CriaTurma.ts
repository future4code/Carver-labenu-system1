...
export const criaTurma = async(req: Request, res: Response): Promise<void> =>{
    try{
        ...
        let turma: Turma
        console.log(!req.body.docentes && !req.body.estudantes)
        console.log(!req.body.docentes && body.estudantes !== null)
        console.log(!body.estudantes && body.docentes !== null)
